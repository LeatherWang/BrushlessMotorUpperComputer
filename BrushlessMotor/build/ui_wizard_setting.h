...
public:
    ...
    void setupUi(QWizard *Wizard_Setting)
    {
        ...
        groupBox_motorFamily = new QGroupBox(wizardPage2);
        ...
        groupBox_motorType = new QGroupBox(wizardPage2);
    ...
    void retranslateUi(QWizard *Wizard_Setting)
    {
        ...
        groupBox_motorFamily->setTitle(QApplication::translate("Wizard_Setting", "Motor Family:", 0));
        radioButton_brush->setText(QApplication::translate("Wizard_Setting", "Brush", 0));
        radioButton_brushless->setText(QApplication::translate("Wizard_Setting", "Brushless", 0));
        groupBox_motorType->setTitle(QApplication::translate("Wizard_Setting", "Motor Type", 0));
        radioButton_linear->setText(QApplication::translate("Wizard_Setting", "Linear", 0));
        radioButton_rotary->setText(QApplication::translate("Wizard_Setting", "Rotary", 0));
